...
class DentateGyrus(Network):
    ...
    def __init__(self, with_gap_junctions=False):
        ...
        self.GC_TO_MC = connect(
            pre_population=self.GCs,
            post_population=self.MCs,
            n_candidates=12,
            n_synapses=1,
        ...
        self.GC_TO_HC = connect(
            pre_population=self.GCs,
            post_population=self.HCs,
            n_candidates=24,
            n_synapses=1,
            target_section_name="proxd",
            tmgsyn_params=tmgsyn_params,
        ...
        self.MC_TO_MC = connect(
            pre_population=self.MCs,
            post_population=self.MCs,
            n_candidates=24,
            n_synapses=3,
            target_section_name="proxd",
        ...
        self.MC_TO_HC = connect(
            pre_population=self.MCs,
            post_population=self.HCs,
            n_candidates=20,
            n_synapses=2,
            target_section_name="midd",
            tmgsyn_params=tmgsyn_params,
            netcon_params=netcon_params,
        )
        ...
        self.BC_TO_GC = connect(
            pre_population=self.BCs,
            post_population=self.GCs,
            n_candidates=560,
            n_synapses=400,
            target_section_name="soma",
            tmgsyn_params=tmgsyn_params,
            netcon_params=netcon_params,
        )
        ...
        self.HC_TO_GC = connect(
            pre_population=self.HCs,
            post_population=self.GCs,
            n_candidates=2000,
            n_synapses=640,
            target_section_name="dd",
            tmgsyn_params=tmgsyn_params,
            netcon_params=netcon_params,
        )
        ...
        self.HC_TO_MC = connect(
            pre_population=self.HCs,
            post_population=self.MCs,
            n_candidates=60,
            n_synapses=4,
            target_section_name="mid1d",
            tmgsyn_params=tmgsyn_params,
            netcon_params=netcon_params,
        )
        ...
        if with_gap_junctions:
            self.BC_TO_BC_gap_junctions = connect_gap(self.BCs, self.BCs, 4, 2)
