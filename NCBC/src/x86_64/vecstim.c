...
#define processElement processElement__VecStim 
...
#define currentIndex _p[0]
#define currentIndex_columnindex 0
#define eventTime _p[1]
#define eventTime_columnindex 1
#define vectorSpace _p[2]
#define vectorSpace_columnindex 2
#define _tsav _p[3]
...
extern "C" {
 ...
 static double _hoc_processElement(void*);
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "play", _hoc_play,
 "processElement", _hoc_processElement,
 0, 0
};
...
{    _p = _pnt->_prop->param; _ppvar = _pnt->_prop->dparam;
 ...
 _tsav = t;   if (_lflag == 1. ) {*(_tqitem) = 0;}
 {
   if ( _lflag  == 1.0 ) {
     net_event ( _pnt, t ) ;
     processElement ( _threadargs_ ) ;
     if ( currentIndex > 0.0 ) {
       artcell_net_send ( _tqitem, _args, _pnt, t +  eventTime - t , 1.0 ) ;
       }
     }
   } }
...
{
 {
   ...
   processElement ( _threadargs_ ) ;
   if ( currentIndex > 0.0 ) {
     artcell_net_send ( _tqitem, (double*)0, _ppvar[1]._pvoid, t +  eventTime - t , 1.0 ) ;
     }
   }
